...
function paintDOM(upcomingEvents) {
    let body = ``;
    const tagToUpdate = document.getElementById("cardFutureEvents");
    ...
    for (let i = 0; i < upcomingEvents.length; i++) {
        ...
        <div class="card" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">${upcomingEvents[i].date}</li>
                        <li class="list-group-item">$ ${upcomingEvents[i].price}</li>
                    </ul>
                    <div class="card-body">
